...
def payments(request):
    ...
    # Move the cart to OrderProduct Table
    ...
    # Send order number and transaction id back to sedData method via JsonResponse
    data = {
...
def place_order(request, total=0, quantity=0):
    ...
    # If the cart count less than equal to 0, then redirect to back to shop
